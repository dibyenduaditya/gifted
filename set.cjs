...
const config = {
  SESSION_ID: process.env.SESSION_ID || "Gifted~Di2yrGQj",
  ...
  STATUS_READ_MSG: process.env.STATUS_READ_MSG || 'Status Viewed by ◣Ꭼᴏη Ꭺᴅɪ֟፝ᴛʏꫝ◥',
  ...
  OWNER_NAME: process.env.OWNER_NAME || "◣Ꭼᴏη Ꭺᴅɪ֟፝ᴛʏꫝ◥",
  OWNER_NUMBER: process.env.OWNER_NUMBER || "917318812338",
